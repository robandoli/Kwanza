...
No grupo, cada toque principal possui um padrão específico de palmas. O M. Jaguara preserva a tradição que lhe foi transmitida e, por esse motivo, mantemos essa forma de execução.

A seguir, o estilo de palmas correspondente a cada toque:

  - **São Bento Pequeno de Angola**: acompanhado por duas palmas.
  - **São Bento Grande de Angola**: acompanhado por quatro palmas.
  - **São Bento Grande da Regional**: acompanhado por três palmas.
  - **Benguela**: acompanhado por trës palmas.
